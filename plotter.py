...
CUMULATIVE_INTERFERENCE_MAXIMUM = 20000
...
def plot(plot_specification):
    ...
    axis2.set_yticks(range(CUMULATIVE_INTERFERENCE_MINIMUM, CUMULATIVE_INTERFERENCE_MAXIMUM, 5000), minor=False)
